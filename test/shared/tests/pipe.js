...
// This test spawns up two clients and connects them both to a server.  The second client then
// broadcasts a chat message which player 1 recieves and responds.
pipeTests.ensure_pipe_works_with_multiple_clients = function(t) {
  ...
  c1.bind('all', function(name) { console.log(name) });
